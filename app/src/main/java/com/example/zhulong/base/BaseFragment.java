...
public class BaseFragment extends Fragment {
     ...
     */
    public void initRecyclerView(RecyclerView pRecyclerView, SmartRefreshLayout pRefreshLayout,RecyclerView.LayoutManager layoutManager, DataListener pDataListener) {
        if (pRecyclerView != null) pRecyclerView.setLayoutManager(layoutManager);
