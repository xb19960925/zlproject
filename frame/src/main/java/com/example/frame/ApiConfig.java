...
public class ApiConfig {
    ...
    public static final int HOME_BANNER_LIVE = 7;
    public static final int HOME_PAGE_DATA = 8;
    ...
    public static final int REGISTER_PHONE = 16;
    public static final int CHECK_PHONE_IS_USED = 17;
